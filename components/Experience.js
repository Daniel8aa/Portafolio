...
const experiences = [
    {
        ...
        area: "Dirección General de Educación Superior",
        period: "2023 – Presente",
        current: true,
        description:
            "Diseño e implementación de sistemas web institucionales para la gestión académica y administrativa. Desarrollo de plataformas de planeación estratégica, chatbots y módulos de bases de datos dinámicos.",
        achievements: [
            "Ecosistema FLEX: plataforma de idiomas con chatbot conversacional 24/7",
            "Suite de Planeación 2026: POA, Plan de Desarrollo e Informe de Labores interconectados",
            "Módulo DB dinámico: CRUD automatizado con cero redundancia",
            "Automatización de reportes Excel institucionales con PhpSpreadsheet",
        ],
        tech: ["Vue.js", "PHP", "MySQL", "Docker", "Linux"],
    },
    {
        role: "Desarrollador Web",
        company: "Proyectos Independientes",
        area: "Freelance / Consultoría",
        period: "2022 – 2023",
        current: false,
        description:
            "Desarrollo de soluciones web a medida para clientes del sector educativo. Enfoque en automatización de procesos y digitalización de flujos de trabajo manuales.",
        achievements: [
            "Desarrollo de aplicaciones móviles con SDK institucional",
            "Mentoría y talleres de desarrollo web para estudiantes",
            "Integración de APIs REST para sistemas de terceros",
        ],
        tech: ["Vue.js", "PHP", "REST API", "Capacitor"],
    },
    {
        role: "Practicante de Desarrollo",
        company: "Universidad de Colima",
        area: "Coordinación de Tecnologías",
        period: "2021 – 2022",
        current: false,
        description:
            "Primer acercamiento al desarrollo institucional. Soporte técnico, administración de bases de datos y desarrollo de módulos web internos.",
        achievements: [
            "Mantenimiento y mejoras de sistemas web internos",
            "Administración de bases de datos MySQL",
            "Documentación técnica de procesos de desarrollo",
        ],
